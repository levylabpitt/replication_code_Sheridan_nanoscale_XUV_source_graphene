...
module restart_oct_m
  ...
  interface drestart_write_binary
    ...
    module procedure drestart_write_binary1_i4, drestart_write_binary2_i4, drestart_write_binary3_i4, drestart_write_binary5_i4
  ...
  interface zrestart_write_binary
    ...
    module procedure zrestart_write_binary1_i4, zrestart_write_binary2_i4, zrestart_write_binary3_i4, zrestart_write_binary5_i4
  ...
  interface drestart_read_binary
    ...
    module procedure drestart_read_binary1_i4, drestart_read_binary2_i4, drestart_read_binary3_i4, drestart_read_binary5_i4
  ...
  interface zrestart_read_binary
    ...
    module procedure zrestart_read_binary1_i4, zrestart_read_binary2_i4, zrestart_read_binary3_i4, zrestart_read_binary5_i4
  ...
  type restart_t
    ...
    type(namespace_t), pointer, public :: namespace !< namespace depending on system to modify path
    ...
    integer(i8), allocatable :: map(:) !< Map between the points of the stored mesh and the mesh used in the current calculations.
  end type restart_t
