...
extern "C" void FC_FUNC_(lihash_map_insert, LIHASH_MAP_INSERT)(map_type8 ** map, const fint8 * key, const fint * val){
  (**map)[*key] = *val;
}

extern "C" void FC_FUNC_(lihash_map_lookup, LIHASH_MAP_LOOKUP)(const map_type8 ** map, const fint8 * key, fint * found, fint * val){
