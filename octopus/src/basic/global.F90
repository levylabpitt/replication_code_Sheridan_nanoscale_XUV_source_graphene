...
contains
  ...
  integer(i8) pure function loptional_default(opt, def) result(val)
    integer(i8), optional, intent(in) :: opt
  ...
  pure function i4_to_i8_1(ii)
    integer(i4), intent(in) :: ii(:)
    integer(i8) :: i4_to_i8_1(lbound(ii, 1, kind=i8):ubound(ii, 1, kind=i8))

    i4_to_i8_1 = int(ii, i8)
  ...
  pure function i8_to_i4_1(ii)
    integer(i8), intent(in) :: ii(:)
    integer(i4) :: i8_to_i4_1(lbound(ii, 1, kind=i8):ubound(ii, 1, kind=i8))

    i8_to_i4_1 = int(ii, i4)
