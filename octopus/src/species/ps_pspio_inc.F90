...
!!
 ...
 ! ---------------------------------------------------------
subroutine ps_pspio_init(ps, namespace, label, z, lmax, ispin, filename)
  ...
  call messages_experimental("Reading pseudopotential file using PSPIO library", namespace=namespace)
